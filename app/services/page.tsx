...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Data engineering, Azure, GCP, AWS, Databricks, OpenAI, data science, AI automation, dashboards, and custom ERP/SaaS development services from TathyaForge.",
  alternates: {
    canonical: "/services",
  },
};
    ...
    <section className="py-20 sm:py-24">
      <Container>
        <SectionHeader
          ...
          description="From raw business facts to reliable Azure, GCP, AWS, multi-cloud, OpenAI, data science, automation, dashboard, and custom software systems, TathyaForge helps teams turn operational complexity into production systems."
        />
